...
Route::controller(AdminSiteInfoController::class)->group(function () {
    ...
    Route::get('/globalVisits', 'visits');

    Route::get('/CountOfvisits', 'CountOfvisits');
});
...
Route::get('getProfileFromId/{id}', [AuthController::class, 'getProfileFromId']);
...
Route::controller(CourseController::class)->group(function () {
    ...
    Route::get('download/setifications', 'downloadCertificateEmail')->name('downloadCertificateEmail');
});
...
Route::controller(RoomController::class)->group(function () {
    ...
    Route::get('getUsersJoinedRoom/{id}', 'getUsersJoinedRoom');
});
...
Route::controller(ReportUserController::class)->group(function () {
    Route::post('reportUser', 'reportUser');
});
...
Route::get('/cheackFromAuroraTeam', function () {
    return view('messageView');
})->name('cheackFromAuroraTeam');
