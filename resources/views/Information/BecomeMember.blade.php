<title>شروط الحصول على العضوية</title>
@extends('Layout')
@section('content')
    <div class="row mt-3">
    ...
    <div class="modal fade" id="Edit">
        <div class="modal-dialog modal-dialog-centered text-center modal-lg" role="document">
            <form method="POST" Action="{{route('BecomeMemberEdit')}}" class="modal-content modal-content-demo">
             @csrf
                <div class="modal-header">
                    <h6 class="modal-title">شروط الحصول على العضوية</h6><button type="button" aria-label="Close" class="btn-close"
