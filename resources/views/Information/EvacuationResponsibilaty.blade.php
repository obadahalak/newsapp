...
@section('content')
    ...
    <div class="modal fade" id="Edit">
        <div class="modal-dialog modal-dialog-centered text-center modal-lg" role="document">
            <form method="POST" Action="{{route('ResponsibilatyEdit')}}" class="modal-content modal-content-demo">
              @csrf
                <div class="modal-header">
                    <h6 class="modal-title">إخلاء المسؤولية</h6><button type="button" aria-label="Close" class="btn-close"
