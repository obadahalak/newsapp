...
<head>
    ...
    <!-- TITLE -->
    <title>الاتحاد الدولي - IFMIS</title>
            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                        <form action="{{route('AuthAdmin')}}" method="POST" class="login100-form validate-form needs-validation">
                            @csrf
                            <span class="login100-form-title pb-5">
                                الاتحاد الدولي - IFMIS
                            </span>
                                ...
                                <div class="panel-body tabs-menu-body p-0 pt-5">
                                    <div class="tab-content">
                                        <div class="wrap-input100 validate-input input-group"
                                            ...
                                            <input class="input100 border-start-0 form-control ms-0" name="email" type="text"email"
                                        ...
                                        <div class="wrap-input100 validate-input input-group" id="Password-toggle">
                                            ...
                                            <input name="password" class="input100 border-start-0 form-control ms-0" type="password"
